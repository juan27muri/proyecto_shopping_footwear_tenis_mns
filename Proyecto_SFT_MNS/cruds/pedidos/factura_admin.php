...
$numero_pedido = (int) $_GET['numero_pedido'];

// Obtener los detalles del pedido
$query_pedido = "SELECT * FROM pedidos WHERE numero_pedido = :numero_pedido";
$stmt_pedido = $base->prepare($query_pedido);
$stmt_pedido->bindParam(':numero_pedido', $numero_pedido, PDO::PARAM_INT);
$stmt_pedido->execute();
...
$query_detalles = "SELECT p.nombre_producto, dp.cantidad, dp.precio, dp.talla, (dp.cantidad * dp.precio) AS total_producto
                    ...
                    WHERE dp.pedido_id = :numero_pedido";
$stmt_detalles = $base->prepare($query_detalles);
$stmt_detalles->bindParam(':numero_pedido', $numero_pedido, PDO::PARAM_INT);
...
$stmt_cliente->bindParam(':usuario_id', $pedido['usuario_id'], PDO::PARAM_INT);
...
$pdf->Output('I', 'Factura_Pedido_' . $pedido['numero_pedido'] . '.pdf');
?>
